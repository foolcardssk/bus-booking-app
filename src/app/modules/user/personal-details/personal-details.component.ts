...
export class PersonalDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private seatBookingService: SeatBookingService, private fb: FormBuilder, private router: Router) { }
  ...
  onSubmit(): void {
    this.personalDetailForms.forEach(form => console.log(form.value));
  }
